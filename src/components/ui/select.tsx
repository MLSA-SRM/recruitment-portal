  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-full items-center justify-between gap-2 rounded-xl border bg-background",
        "px-4 py-3 text-base shadow-sm transition-all duration-200 outline-none",
        ...
        // Content styling
        "*:[slot=select-value]:line-clamp-1 *:[slot=select-value]:flex *:[slot=select-value]:items-center *:[slot=select-value]:gap-2",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "relative flex w-full cursor-default items-center gap-3 rounded-lg py-3 pr-10 pl-3 text-base",
